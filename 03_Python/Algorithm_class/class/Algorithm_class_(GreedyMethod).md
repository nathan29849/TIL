...
- 처리시간이 작은 작업부터 차례대로 처리하면 평균적인 대기 시간이 최소가 된다.
  ...
  > 이 처리 순서에서 j < k이고 p(ij) > p(ik)인 두 작업 ij, ik가 있다면(순서가 크지만, 작업시간은 더 작은 경우), 이 작업의 순서를 교환하면, 대기시간 총 합이 줄어들지 않음을 보이면 된다.

![](https://images.velog.io/images/nathan29849/post/ac25978e-4455-4c13-b49b-e06717ef5d9a/image.png)
